...
var ProductFromGroup = (function (_super) {
    __extends(ProductFromGroup, _super);
    function ProductFromGroup() {
        _super.call(this, {
    ...
    Object.defineProperty(ProductFromGroup.prototype, "productControls", {
        get: function () {
            var _this = this;
    ...
    ProductFromGroup.prototype.getFormValidationMessages = function () {
        var messages = [];
...
exports.ProductFromGroup = ProductFromGroup;
