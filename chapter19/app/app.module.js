    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [component_1.ProductComponent, attr_directive_1.PaAttrDirective, twoway_directive_1.PaModel, paif_directive_1.PaStructureDirective, iterator_directive_1.PaIteratorDirective,
                ...
                discountAmount_directive_1.PaDiscountAmountDirective, datasource_model_1.SimpleDataSource, repository_model_1.Model],
            providers: [{ provide: core_2.LOCALE_ID, useValue: "nl-BE" }, discount_service_1.DiscountService],
