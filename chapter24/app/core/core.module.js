        ...
        core_1.NgModule({
            ...
            providers: [{
                    ...
                    useFactory: function (messageService, model) {
                        ...
                        subject.subscribe(function (m) { return messageService.reportMessage(new message_model_1.Message(sharedState_model_2.MODES[m.mode] + (m.id != undefined ? " " + model.getProduct(m.id).name : ""))); });
                        return subject;
                    }
                }]
        }), 
